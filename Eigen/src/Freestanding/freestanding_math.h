...
#  if defined(__STDC_HOSTED__) && __STDC_HOSTED__ == 0
    // We're in freestanding mode - include C math header only
// #pragma message "We're in freestanding mode - include C math header only"
...
#  else
    // We're in hosted mode - use standard <cmath>
// #pragma message "We're in hosted mode - use standard <cmath>"
#    include <cmath>
#  endif
#else
  // Non-GCC, fallback
// #pragma message "<math.h> Non-GCC, fallback"
#  include <math.h>
#endif
